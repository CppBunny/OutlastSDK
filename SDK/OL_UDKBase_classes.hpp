...
// 0x0044 (0x06C0 - 0x067C)
class AMobileHUDExt : public AMobileHUD
{
public:
	class UTexture2D*                                  TapToMoveTexture;                                         // 0x067C(0x0008)
	float                                              LastTapToMoveEffectTime;                                  // 0x0684(0x0004)
	struct FVector2D                                   TapToMoveEffectPos;                                       // 0x0688(0x0008)
	unsigned long                                      bFlashJoysticks : 1;                                      // 0x0690(0x0004)
	float                                              FlashTime;                                                // 0x0694(0x0004)
	class UFont*                                       BenchmarkFont;                                            // 0x0698(0x0008)
	class UTexture2D*                                  BenchmarkBackground;                                      // 0x06A0(0x0008)
	struct FTextureUVs                                 BenchmarkBackgroundUVs;                                   // 0x06A8(0x0010)
	float                                              BenchmarkResolutionScale;                                 // 0x06B8(0x0004)
	int                                                BenchmarkFeatureLevel;                                    // 0x06BC(0x0004)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.MobileHUDExt");
		return ptr;
	}
...
{
public:
	class AUDKSquadAI*                                 Squad;                                                    // 0x0450(0x0008)
	class UUDKAIDecisionComponent*                     DecisionComponent;                                        // 0x0458(0x0008) (ExportObject, Component, EditInline)
	class AActor*                                      TemporaryFocus;                                           // 0x0460(0x0008)
	unsigned long                                      bExecutingWhatToDoNext : 1;                               // 0x0468(0x0004)
	unsigned long                                      bScriptSpecialJumpCost : 1;                               // 0x0468(0x0004)
	unsigned long                                      bForceRefreshRoute : 1;                                   // 0x0468(0x0004)
	unsigned long                                      bTargetAlternateLoc : 1;                                  // 0x0468(0x0004)
	unsigned long                                      bEnemyInfoValid : 1;                                      // 0x0468(0x0004)
	unsigned long                                      bEnemyIsVisible : 1;                                      // 0x0468(0x0004)
	unsigned long                                      bLeadTarget : 1;                                          // 0x0468(0x0004)
	unsigned long                                      bJumpOverWall : 1;                                        // 0x0468(0x0004)
	unsigned long                                      bPlannedJump : 1;                                         // 0x0468(0x0004)
	unsigned long                                      bInDodgeMove : 1;                                         // 0x0468(0x0004)
	unsigned long                                      bEnemyAcquired : 1;                                       // 0x0468(0x0004)
	unsigned long                                      bNeedDelayedLeaveVehicle : 1;                             // 0x0468(0x0004)
	unsigned long                                      bAllowRouteReuse : 1;                                     // 0x0468(0x0004)
	unsigned long                                      bUsingSquadRoute : 1;                                     // 0x0468(0x0004)
	unsigned long                                      bUsePreviousSquadRoute : 1;                               // 0x0468(0x0004)
	unsigned char                                      ScriptedFireMode;                                         // 0x046C(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x046D(0x0003) MISSED OFFSET
	float                                              EnemyVisibilityTime;                                      // 0x0470(0x0004)
	class APawn*                                       VisibleEnemy;                                             // 0x0474(0x0008)
	class AVehicle*                                    LastBlockingVehicle;                                      // 0x047C(0x0008)
	class APawn*                                       CurrentlyTrackedEnemy;                                    // 0x0484(0x0008)
	TArray<struct FEnemyPosition>                      SavedPositions;                                           // 0x048C(0x0010) (NeedCtorLink)
	struct FVector                                     ImpactVelocity;                                           // 0x049C(0x000C)
	int                                                AcquisitionYawRate;                                       // 0x04A8(0x0004)
	float                                              HearingThreshold;                                         // 0x04AC(0x0004)
	float                                              RespawnPredictionTime;                                    // 0x04B0(0x0004)
	float                                              WarningDelay;                                             // 0x04B4(0x0004)
	class AProjectile*                                 WarningProjectile;                                        // 0x04B8(0x0008)
	struct FVector                                     MonitorStartLoc;                                          // 0x04C0(0x000C)
	class APawn*                                       MonitoredPawn;                                            // 0x04CC(0x0008)
	float                                              MonitorMaxDistSq;                                         // 0x04D4(0x0004)
	struct FVector                                     LastSeenPos;                                              // 0x04D8(0x000C)
	struct FVector                                     LastSeeingPos;                                            // 0x04E4(0x000C)
	float                                              LastSeenTime;                                             // 0x04F0(0x0004)
	float                                              TrackingReactionTime;                                     // 0x04F4(0x0004)
	float                                              BaseTrackingReactionTime;                                 // 0x04F8(0x0004)
	struct FVector                                     TrackedVelocity;                                          // 0x04FC(0x000C)
	class ANavigationPoint*                            SquadRouteGoal;                                           // 0x0508(0x0008)
	class APawn*                                       BlockedAimTarget;                                         // 0x0510(0x0008)
	float                                              LastIterativeCheck;                                       // 0x0518(0x0004)
	float                                              AimUpdateFrequency;                                       // 0x051C(0x0004)
	float                                              LastAimUpdateTime;                                        // 0x0520(0x0004)
	float                                              ErrorUpdateFrequency;                                     // 0x0524(0x0004)
	float                                              LastErrorUpdateTime;                                      // 0x0528(0x0004)
	float                                              CurrentAimError;                                          // 0x052C(0x0004)
	float                                              DodgeLandZ;                                               // 0x0530(0x0004)
	class AActor*                                      FearSpots[0x2];                                           // 0x0534(0x0008)
	float                                              DodgeToGoalPct;                                           // 0x0544(0x0004)
	float                                              MultiJumpZ;                                               // 0x0548(0x0004)
...
{
public:
	class ATeamInfo*                                   Team;                                                     // 0x0240(0x0008) (Net)
	class ANavigationPoint*                            LastAnchor;                                               // 0x0248(0x0008) (Const)
	float                                              LastValidAnchorTime;                                      // 0x0250(0x0004)
	class USkeletalMeshComponent*                      SkelMesh;                                                 // 0x0254(0x0008) (ExportObject, Component, EditInline)
	unsigned long                                      bHome : 1;                                                // 0x025C(0x0004) (Net)
	class AUDKGameObjective*                           HomeBase;                                                 // 0x0260(0x0008) (Net)
	struct FVector                                     HomeBaseOffset;                                           // 0x0268(0x000C)
	class AActor*                                      OldBase;                                                  // 0x0274(0x0008)
	class AActor*                                      OldBaseBase;                                              // 0x027C(0x0008)
	struct FVector                                     HUDLocation;                                              // 0x0284(0x000C)
...
{
public:
	float                                              DistFromCamera;                                           // 0x0254(0x0004) (Edit)
	class AUDKPlayerController*                        Cam;                                                      // 0x0258(0x0008)
...
{
public:
	TArray<struct FAttachedExplosionLight>             RelativeExplosionLights;                                  // 0x02B0(0x0010) (Component, NeedCtorLink)
...
{
public:
	unsigned long                                      bCheckFrameRate : 1;                                      // 0x0250(0x0004)
	unsigned long                                      bInitialized : 1;                                         // 0x0250(0x0004)
	float                                              HighDetailFrameTime;                                      // 0x0254(0x0004)
	float                                              Lifetime;                                                 // 0x0258(0x0004)
	int                                                TimeShiftIndex;                                           // 0x025C(0x0004)
	TArray<struct FLightValues>                        TimeShift;                                                // 0x0260(0x0010) (Edit, NeedCtorLink)
	struct FScriptDelegate                             __OnLightFinished__Delegate;                              // 0x0270(0x0010) (NeedCtorLink)
...
// 0x0030 (0x0304 - 0x02D4)
class AUDKForcedDirectionVolume : public APhysicsVolume
{
public:
	class UClass*                                      TypeToForce;                                              // 0x02D4(0x0008) (Edit)
	unsigned long                                      bIgnoreHoverboards : 1;                                   // 0x02DC(0x0004) (Edit)
	unsigned long                                      bDenyExit : 1;                                            // 0x02DC(0x0004) (Edit)
	unsigned long                                      bBlockPawns : 1;                                          // 0x02DC(0x0004) (Edit)
	unsigned long                                      bBlockSpectators : 1;                                     // 0x02DC(0x0004) (Edit)
	class UArrowComponent*                             Arrow;                                                    // 0x02E0(0x0008) (Edit, Const, ExportObject, Component, EditInline)
	struct FVector                                     ArrowDirection;                                           // 0x02E8(0x000C)
	TArray<class AUDKVehicle*>                         TouchingVehicles;                                         // 0x02F4(0x0010) (NeedCtorLink)
...
{
public:
	TArray<class ANavigationPoint*>                    ShootSpots;                                               // 0x0358(0x0010) (NeedCtorLink)
	unsigned long                                      bAllowOnlyShootable : 1;                                  // 0x0368(0x0004)
	unsigned long                                      bUnderAttack : 1;                                         // 0x0368(0x0004) (Net)
	struct FVector                                     HUDLocation;                                              // 0x036C(0x000C)
	class UTexture2D*                                  IconHudTexture;                                           // 0x0378(0x0008) (Const)
	struct FTextureCoordinates                         IconCoords;                                               // 0x0380(0x0010)
	unsigned char                                      DefenderTeamIndex;                                        // 0x0390(0x0001) (Net)
...
{
public:
	class UFont*                                       GlowFonts[0x2];                                           // 0x067C(0x0008)
	float                                              PulseDuration;                                            // 0x068C(0x0004)
	float                                              PulseSplit;                                               // 0x0690(0x0004)
	float                                              PulseMultiplier;                                          // 0x0694(0x0004)
	struct FFontRenderInfo                             TextRenderInfo;                                           // 0x0698(0x0028)
	class UFont*                                       ConsoleIconFont;                                          // 0x06C0(0x0008)
	class UFont*                                       BindTextFont;                                             // 0x06C8(0x0008)
...
{
public:
	struct FVector                                     JumpVelocity;                                             // 0x0358(0x000C)
	class APathNode*                                   JumpTarget;                                               // 0x0364(0x0008) (Edit)
	class USoundCue*                                   JumpSound;                                                // 0x036C(0x0008) (Edit)
	float                                              JumpTime;                                                 // 0x0374(0x0004) (Edit)
	float                                              JumpAirControl;                                           // 0x0378(0x0004) (Edit)
	class UAudioComponent*                             JumpAmbientSound;                                         // 0x037C(0x0008) (ExportObject, Component, EditInline)
...
{
public:
	unsigned long                                      bHasHealth : 1;                                           // 0x0368(0x0004) (Edit)
	unsigned long                                      bDamageOnEncroachment : 1;                                // 0x0368(0x0004) (Edit)
	unsigned long                                      bResetDOEWhenAsleep : 1;                                  // 0x0368(0x0004) (Edit)
	unsigned long                                      bTakeDamageOnEncroachment : 1;                            // 0x0368(0x0004) (Edit)
	unsigned long                                      bBreakWhenCausingDamage : 1;                              // 0x0368(0x0004) (Edit)
	unsigned long                                      bBroken : 1;                                              // 0x0368(0x0004)
	int                                                Health;                                                   // 0x036C(0x0004) (Edit)
	int                                                EncroachDamage_Other;                                     // 0x0370(0x0004) (Edit)
	int                                                EncroachDamage_Self;                                      // 0x0374(0x0004) (Edit)
	class UClass*                                      DmgTypeClass;                                             // 0x0378(0x0008) (Edit)
	int                                                DOEResetThreshold;                                        // 0x0380(0x0004) (Edit)
	class UParticleSystem*                             BrokenTemplate;                                           // 0x0384(0x0008) (Edit)
	class AController*                                 InstigatorController;                                     // 0x038C(0x0008)
	struct FScriptDelegate                             __OnBreakApart__Delegate;                                 // 0x0394(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnEncroach__Delegate;                                   // 0x03A4(0x0010) (NeedCtorLink)
...
{
public:
	float                                              FOV;                                                      // 0x0384(0x0004) (Const)
	unsigned long                                      bHasSavedScale3D : 1;                                     // 0x0388(0x0004) (Const)
	struct FVector                                     SavedScale3D;                                             // 0x038C(0x000C) (Const)
...
// 0x0238 (0x078C - 0x0554)
class AUDKPawn : public AGamePawn
{
public:
	unsigned long                                      bReadyToDoubleJump : 1;                                   // 0x0554(0x0004)
	unsigned long                                      bRequiresDoubleJump : 1;                                  // 0x0554(0x0004)
	unsigned long                                      bCanDoubleJump : 1;                                       // 0x0554(0x0004)
	unsigned long                                      bNoJumpAdjust : 1;                                        // 0x0554(0x0004)
	unsigned long                                      bIsHoverboardAnimPawn : 1;                                // 0x0554(0x0004)
	unsigned long                                      bFeigningDeath : 1;                                       // 0x0554(0x0004) (Net)
	unsigned long                                      bNotifyStopFalling : 1;                                   // 0x0554(0x0004)
	unsigned long                                      bIsInvisible : 1;                                         // 0x0554(0x0004) (Net)
	unsigned long                                      bSmoothNetUpdates : 1;                                    // 0x0554(0x0004)
	unsigned long                                      bPuttingDownWeapon : 1;                                   // 0x0554(0x0004) (Net)
	unsigned long                                      bPlayingFeignDeathRecovery : 1;                           // 0x0554(0x0004)
	unsigned long                                      bCanPlayFallingImpacts : 1;                               // 0x0554(0x0004)
	unsigned long                                      bEnableFootPlacement : 1;                                 // 0x0554(0x0004)
	unsigned long                                      bPostRenderOtherTeam : 1;                                 // 0x0554(0x0004)
	unsigned long                                      bBlendOutTakeHitPhysics : 1;                              // 0x0554(0x0004)
	unsigned long                                      bUpdateEyeheight : 1;                                     // 0x0554(0x0004)
	unsigned long                                      bTearOffGibs : 1;                                         // 0x0554(0x0004) (Net)
	float                                              MaxDoubleJumpHeight;                                      // 0x0558(0x0004)
	int                                                MultiJumpRemaining;                                       // 0x055C(0x0004)
	int                                                MaxMultiJump;                                             // 0x0560(0x0004)
	int                                                MultiJumpBoost;                                           // 0x0564(0x0004)
	float                                              CustomGravityScaling;                                     // 0x0568(0x0004) (Net)
	struct FPlayEmoteInfo                              EmoteRepInfo;                                             // 0x056C(0x0010) (Net)
	float                                              LastEmoteTime;                                            // 0x057C(0x0004)
	float                                              MinTimeBetweenEmotes;                                     // 0x0580(0x0004)
	unsigned char                                      BigTeleportCount;                                         // 0x0584(0x0001) (Net)
	unsigned char                                      WeaponOverlayFlags;                                       // 0x0585(0x0001) (Net)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0586(0x0002) MISSED OFFSET
	struct FUTTakeHitInfo                              LastTakeHitInfo;                                          // 0x0588(0x002C) (Net)
	float                                              LastTakeHitTimeout;                                       // 0x05B4(0x0004)
	float                                              FireRateMultiplier;                                       // 0x05B8(0x0004) (Net)
	float                                              HeadScale;                                                // 0x05BC(0x0004) (Net)
	float                                              MaxSmoothNetUpdateDist;                                   // 0x05C0(0x0004)
	float                                              NoSmoothNetUpdateDist;                                    // 0x05C4(0x0004)
	float                                              SmoothNetUpdateTime;                                      // 0x05C8(0x0004)
	struct FVector                                     MeshTranslationOffset;                                    // 0x05CC(0x000C)
	float                                              OldZ;                                                     // 0x05D8(0x0004)
	class UAudioComponent*                             PawnAmbientSound;                                         // 0x05DC(0x0008) (ExportObject, Component, EditInline)
	class USoundCue*                                   PawnAmbientSoundCue;                                      // 0x05E4(0x0008) (Net)
	struct FDrivenWeaponPawnInfo                       DrivenWeaponPawn;                                         // 0x05EC(0x0014) (Net)
	class UAudioComponent*                             WeaponAmbientSound;                                       // 0x0600(0x0008) (ExportObject, Component, EditInline)
	class USoundCue*                                   WeaponAmbientSoundCue;                                    // 0x0608(0x0008) (Net)
	class UMaterial*                                   ReplicatedBodyMaterial;                                   // 0x0610(0x0008) (Net)
	TArray<class UMaterialInstanceConstant*>           BodyMaterialInstances;                                    // 0x0618(0x0010) (NeedCtorLink)
	class UMaterialInterface*                          OverlayMaterialInstance;                                  // 0x0628(0x0008) (Net)
	class USkelControlSingleBone*                      RootRotControl;                                           // 0x0630(0x0008)
	class UAnimNodeAimOffset*                          AimNode;                                                  // 0x0638(0x0008)
	class UGameSkelCtrl_Recoil*                        GunRecoilNode;                                            // 0x0640(0x0008)
	class UGameSkelCtrl_Recoil*                        LeftRecoilNode;                                           // 0x0648(0x0008)
	class UGameSkelCtrl_Recoil*                        RightRecoilNode;                                          // 0x0650(0x0008)
	TArray<class AUDKBot*>                             Trackers;                                                 // 0x0658(0x0010) (NeedCtorLink)
	float                                              BodyMatFadeDuration;                                      // 0x0668(0x0004)
	struct FLinearColor                                CurrentBodyMatColor;                                      // 0x066C(0x0010)
	float                                              RemainingBodyMatDuration;                                 // 0x067C(0x0004)
	float                                              ClientBodyMatDuration;                                    // 0x0680(0x0004) (Net)
	struct FLinearColor                                BodyMatColor;                                             // 0x0684(0x0010)
	struct FRotator                                    CompressedBodyMatColor;                                   // 0x0694(0x000C) (Net)
	float                                              StartFallImpactTime;                                      // 0x06A0(0x0004)
	struct FName                                       TorsoBoneName;                                            // 0x06A4(0x0008)
	class USoundCue*                                   FallImpactSound;                                          // 0x06AC(0x0008)
	float                                              FallSpeedThreshold;                                       // 0x06B4(0x0004)
	class UStaticMeshComponent*                        BlobShadow;                                               // 0x06B8(0x0008) (ExportObject, Component, EditInline)
	class USkeletalMeshComponent*                      OverlayMesh;                                              // 0x06C0(0x0008) (ExportObject, Component, EditInline)
	struct FName                                       LeftFootBone;                                             // 0x06C8(0x0008)
	struct FName                                       RightFootBone;                                            // 0x06D0(0x0008)
	struct FName                                       LeftFootControlName;                                      // 0x06D8(0x0008)
	struct FName                                       RightFootControlName;                                     // 0x06E0(0x0008)
	float                                              BaseTranslationOffset;                                    // 0x06E8(0x0004)
	float                                              CrouchTranslationOffset;                                  // 0x06EC(0x0004)
	float                                              OldLocationZ;                                             // 0x06F0(0x0004)
	float                                              ZSmoothingRate;                                           // 0x06F4(0x0004) (Const)
	float                                              MaxFootPlacementDistSquared;                              // 0x06F8(0x0004)
	class USkelControlFootPlacement*                   LeftLegControl;                                           // 0x06FC(0x0008)
	class USkelControlFootPlacement*                   RightLegControl;                                          // 0x0704(0x0008)
	class USkelControlLimb*                            LeftHandIK;                                               // 0x070C(0x0008)
	class USkelControlLimb*                            RightHandIK;                                              // 0x0714(0x0008)
	struct FName                                       DamageParameterName;                                      // 0x071C(0x0008)
	struct FName                                       SaturationParameterName;                                  // 0x0724(0x0008)
	float                                              LastPostRenderTraceTime;                                  // 0x072C(0x0004)
	float                                              TeamBeaconMaxDist;                                        // 0x0730(0x0004) (Edit)
	float                                              StartedFallingTime;                                       // 0x0734(0x0004)
	float                                              SlopeBoostFriction;                                       // 0x0738(0x0004)
	class UAnimNodeAimOffset*                          FlyingDirOffset;                                          // 0x073C(0x0008)
	int                                                MaxLeanRoll;                                              // 0x0744(0x0004)
	float                                              FeignDeathPhysicsBlendOutSpeed;                           // 0x0748(0x0004)
	float                                              SwimmingZOffset;                                          // 0x074C(0x0004) (Edit)
	float                                              SwimmingZOffsetSpeed;                                     // 0x0750(0x0004) (Edit)
	float                                              CrouchMeshZOffset;                                        // 0x0754(0x0004)
	float                                              TakeHitPhysicsBlendOutSpeed;                              // 0x0758(0x0004)
	class UUDKSkeletalMeshComponent*                   ArmsMesh[0x2];                                            // 0x075C(0x0008) (ExportObject, Component, EditInline)
	int                                                RootYaw;                                                  // 0x076C(0x0004)
	float                                              RootYawSpeed;                                             // 0x0770(0x0004)
	int                                                MaxYawAim;                                                // 0x0774(0x0004) (Edit)
	struct FVector2D                                   CurrentSkelAim;                                           // 0x0778(0x0008)
	struct FVector                                     HUDLocation;                                              // 0x0780(0x000C)
...
// 0x00C0 (0x0444 - 0x0384)
class AUDKPickupFactory : public APickupFactory
{
public:
	unsigned long                                      bIsRespawning : 1;                                        // 0x0384(0x0004) (Net)
	unsigned long                                      bPulseBase : 1;                                           // 0x0384(0x0004) (Net)
	unsigned long                                      bIsDisabled : 1;                                          // 0x0384(0x0004) (Net)
	unsigned long                                      bFloatingPickup : 1;                                      // 0x0384(0x0004)
	unsigned long                                      bRandomStart : 1;                                         // 0x0384(0x0004)
	unsigned long                                      bRotatingPickup : 1;                                      // 0x0384(0x0004)
	unsigned long                                      bUpdatingPickup : 1;                                      // 0x0384(0x0004)
	unsigned long                                      bDoVisibilityFadeIn : 1;                                  // 0x0384(0x0004)
	class UStaticMeshComponent*                        BaseMesh;                                                 // 0x0388(0x0008) (ExportObject, Transient, Component, EditInline)
	class UMaterialInstanceConstant*                   BaseMaterialInstance;                                     // 0x0390(0x0008)
	struct FLinearColor                                BaseBrightEmissive;                                       // 0x0398(0x0010)
	struct FLinearColor                                BaseDimEmissive;                                          // 0x03A8(0x0010)
	float                                              BasePulseRate;                                            // 0x03B8(0x0004)
	float                                              BasePulseTime;                                            // 0x03BC(0x0004)
	float                                              PulseThreshold;                                           // 0x03C0(0x0004)
	struct FLinearColor                                BaseTargetEmissive;                                       // 0x03C4(0x0010)
	struct FLinearColor                                BaseEmissive;                                             // 0x03D4(0x0010)
	struct FName                                       BaseMaterialParamName;                                    // 0x03E4(0x0008)
	float                                              BobTimer;                                                 // 0x03EC(0x0004)
	float                                              BobOffset;                                                // 0x03F0(0x0004)
	float                                              BobSpeed;                                                 // 0x03F4(0x0004)
	float                                              BobBaseOffset;                                            // 0x03F8(0x0004)
	float                                              YawRotationRate;                                          // 0x03FC(0x0004)
	struct FVector                                     PivotTranslation;                                         // 0x0400(0x000C)
	struct FName                                       VisibilityParamName;                                      // 0x040C(0x0008)
	class UMaterialInstanceConstant*                   MIC_Visibility;                                           // 0x0414(0x0008)
	class UMaterialInstanceConstant*                   MIC_VisibilitySecondMaterial;                             // 0x041C(0x0008)
	class UParticleSystemComponent*                    Glow;                                                     // 0x0424(0x0008) (ExportObject, Component, EditInline)
	struct FName                                       GlowEmissiveParam;                                        // 0x042C(0x0008)
	class UPrimitiveComponent*                         Spinner;                                                  // 0x0434(0x0008) (ExportObject, Component, EditInline)
	class UUDKParticleSystemComponent*                 SpinningParticleEffects;                                  // 0x043C(0x0008) (ExportObject, Component, EditInline)
...
// 0x0304 (0x0A4C - 0x0748)
class AUDKPlayerController : public AGamePlayerController
{
public:
	class UCameraAnimInst*                             CameraAnimPlayer;                                         // 0x0748(0x0008)
	class AUDKEmitCameraEffect*                        CameraEffect;                                             // 0x0750(0x0008)
	unsigned long                                      bDedicatedServerSpectator : 1;                            // 0x0758(0x0004)
	unsigned long                                      bAcuteHearing : 1;                                        // 0x0758(0x0004)
	unsigned long                                      bConsolePlayer : 1;                                       // 0x0758(0x0004)
	unsigned long                                      bPulseTeamColor : 1;                                      // 0x0758(0x0004)
	unsigned long                                      bUsePhysicsRotation : 1;                                  // 0x0758(0x0004)
	struct FVector                                     ShakeOffset;                                              // 0x075C(0x000C)
	struct FRotator                                    ShakeRot;                                                 // 0x0768(0x000C)
	struct FPostProcessSettings                        CamOverridePostProcess;                                   // 0x0774(0x0160) (NeedCtorLink)
	struct FPostProcessSettings                        PostProcessModifier;                                      // 0x08D4(0x0160) (NeedCtorLink)
	TArray<class AActor*>                              PotentiallyHiddenActors;                                  // 0x0A34(0x0010) (NeedCtorLink)
	float                                              VehicleCheckRadiusScaling;                                // 0x0A44(0x0004)
	float                                              PulseTimer;                                               // 0x0A48(0x0004)
...
{
public:
	unsigned long                                      bWideCheck : 1;                                           // 0x029C(0x0004) (Net)
	unsigned long                                      bShuttingDown : 1;                                        // 0x029C(0x0004)
	unsigned long                                      bCheckProjectileLight : 1;                                // 0x029C(0x0004)
	unsigned long                                      bNotBlockedByShield : 1;                                  // 0x029C(0x0004)
	float                                              CheckRadius;                                              // 0x02A0(0x0004)
	float                                              AccelRate;                                                // 0x02A4(0x0004)
	class AActor*                                      SeekTarget;                                               // 0x02A8(0x0008) (Net)
	float                                              BaseTrackingStrength;                                     // 0x02B0(0x0004)
	float                                              HomingTrackingStrength;                                   // 0x02B4(0x0004)
	struct FVector                                     InitialDir;                                               // 0x02B8(0x000C) (Net)
	float                                              LastLockWarningTime;                                      // 0x02C4(0x0004)
	float                                              LockWarningInterval;                                      // 0x02C8(0x0004)
	float                                              TerminalVelocity;                                         // 0x02CC(0x0004)
	float                                              Buoyancy;                                                 // 0x02D0(0x0004)
	float                                              CustomGravityScaling;                                     // 0x02D4(0x0004)
	class AVehicle*                                    InstigatorBaseVehicle;                                    // 0x02D8(0x0008) (Net)
...
{
public:
	unsigned long                                      bRequiresDoubleJump : 1;                                  // 0x05E8(0x0004)
	float                                              MaxDoubleJumpHeight;                                      // 0x05EC(0x0004)
	class UClass*                                      PrototypePawnClass;                                       // 0x05F0(0x0008)
	struct FName                                       SizePersonFindName;                                       // 0x05F8(0x0008)
...
{
public:
	unsigned long                                      bScriptSpecifyEndAnchor : 1;                              // 0x0358(0x0004)
	unsigned long                                      bScriptNotifyAnchorFindingResult : 1;                     // 0x0358(0x0004)
	unsigned long                                      bAnchorMustBeReachable : 1;                               // 0x0358(0x0004)
...
{
public:
	float                                              FOV;                                                      // 0x0740(0x0004) (Edit, Const)
	unsigned long                                      bForceLoadTextures : 1;                                   // 0x0744(0x0004)
	float                                              ClearStreamingTime;                                       // 0x0748(0x0004)
...
{
public:
	class ATeamInfo*                                   Team;                                                     // 0x0240(0x0008)
...
{
public:
	class AUDKGameObjective*                           SquadObjective;                                           // 0x0248(0x0008) (Net)
	class ANavigationPoint*                            RouteObjective;                                           // 0x0250(0x0008)
	TArray<class ANavigationPoint*>                    ObjectiveRouteCache;                                      // 0x0258(0x0010) (NeedCtorLink)
	TArray<class ANavigationPoint*>                    PreviousObjectiveRouteCache;                              // 0x0268(0x0010) (NeedCtorLink)
	class AUDKBot*                                     PendingSquadRouteMaker;                                   // 0x0278(0x0008)
	int                                                SquadRouteIteration;                                      // 0x0280(0x0004)
	TArray<struct FAlternateRoute>                     SquadRoutes;                                              // 0x0284(0x0010) (NeedCtorLink)
	int                                                MaxSquadRoutes;                                           // 0x0294(0x0004)
...
{
public:
	unsigned char                                      TeamNumber;                                               // 0x0368(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0369(0x0003) MISSED OFFSET
	TArray<class UTexture2D*>                          TeamSprites;                                              // 0x036C(0x0010) (NeedCtorLink)
...
// 0x0040 (0x03C4 - 0x0384)
class AUDKTeleporterBase : public ATeleporter
{
public:
	class USceneCaptureComponent*                      PortalCaptureComponent;                                   // 0x0384(0x0008) (Edit, ExportObject, EditConst, Component, EditInline)
	class UTextureRenderTarget2D*                      TextureTarget;                                            // 0x038C(0x0008)
	int                                                TextureResolutionX;                                       // 0x0394(0x0004) (Edit)
	int                                                TextureResolutionY;                                       // 0x0398(0x0004) (Edit)
	class AActor*                                      PortalViewTarget;                                         // 0x039C(0x0008)
	class UMaterialInterface*                          PortalMaterial;                                           // 0x03A4(0x0008)
	class UMaterialInstanceConstant*                   PortalMaterialInstance;                                   // 0x03AC(0x0008)
	struct FName                                       PortalTextureParameter;                                   // 0x03B4(0x0008)
	class USoundCue*                                   TeleportingSound;                                         // 0x03BC(0x0008)
...
{
public:
	unsigned long                                      bShouldEject : 1;                                         // 0x0718(0x0004)
...
// 0x0208 (0x0924 - 0x071C)
class AUDKVehicle : public AUDKVehicleBase
{
public:
	unsigned long                                      bEjectKilledBodies : 1;                                   // 0x071C(0x0004)
	unsigned long                                      bHomingTarget : 1;                                        // 0x071C(0x0004)
	unsigned long                                      bFrontalCollision : 1;                                    // 0x071C(0x0004) (Const)
	unsigned long                                      bFrontalCollisionWithFixed : 1;                           // 0x071C(0x0004) (Const)
	unsigned long                                      bNoZDampingInAir : 1;                                     // 0x071C(0x0004)
	unsigned long                                      bNoZDamping : 1;                                          // 0x071C(0x0004)
	unsigned long                                      bIsDisabled : 1;                                          // 0x071C(0x0004) (Net)
	unsigned long                                      bIsBurning : 1;                                           // 0x071C(0x0004)
	unsigned long                                      bEjectPassengersWhenFlipped : 1;                          // 0x071C(0x0004)
	unsigned long                                      bIsScraping : 1;                                          // 0x071C(0x0004)
	unsigned long                                      bTakeWaterDamageWhileDriving : 1;                         // 0x071C(0x0004)
	unsigned long                                      bIsInDestroyablePenetration : 1;                          // 0x071C(0x0004)
	unsigned long                                      bDeadVehicle : 1;                                         // 0x071C(0x0004) (Net)
	unsigned long                                      bJostleWhileDriving : 1;                                  // 0x071C(0x0004)
	unsigned long                                      bFloatWhenDriven : 1;                                     // 0x071C(0x0004)
	unsigned long                                      bAllowedExit : 1;                                         // 0x071C(0x0004)
	unsigned long                                      bUseAlternatePaths : 1;                                   // 0x071C(0x0004)
	unsigned long                                      bShowLocked : 1;                                          // 0x071C(0x0004)
	unsigned long                                      bTeamLocked : 1;                                          // 0x071C(0x0004) (Net)
	unsigned long                                      bDisableRepulsorsAtMaxFallSpeed : 1;                      // 0x071C(0x0004)
	unsigned long                                      bTrickJumping : 1;                                        // 0x071C(0x0004) (Net)
	unsigned long                                      bGrab1 : 1;                                               // 0x071C(0x0004) (Net)
	unsigned long                                      bGrab2 : 1;                                               // 0x071C(0x0004) (Net)
	unsigned long                                      bForceSpinWarmup : 1;                                     // 0x071C(0x0004) (Net)
	float                                              RemainingBurn;                                            // 0x0720(0x0004)
	TArray<struct FBurnOutDatum>                       BurnOutMaterialInstances;                                 // 0x0724(0x0010) (NeedCtorLink)
	class UAudioComponent*                             TireAudioComp;                                            // 0x0734(0x0008) (Edit, Const, ExportObject, EditConst, Component, EditInline)
	TArray<struct FMaterialSoundEffect>                TireSoundList;                                            // 0x073C(0x0010) (Edit, NeedCtorLink)
	struct FName                                       CurrentTireMaterial;                                      // 0x074C(0x0008)
	float                                              MaxWheelEffectDistSq;                                     // 0x0754(0x0004)
	TArray<struct FMaterialParticleEffect>             WheelParticleEffects;                                     // 0x0758(0x0010) (NeedCtorLink)
	float                                              LastCheckUpsideDownTime;                                  // 0x0768(0x0004)
	float                                              FlippedCount;                                             // 0x076C(0x0004)
	class UAudioComponent*                             ScrapeSound;                                              // 0x0770(0x0008) (Edit, ExportObject, Component, EditInline)
	float                                              FireDamageThreshold;                                      // 0x0778(0x0004)
	float                                              FireDamagePerSec;                                         // 0x077C(0x0004)
	float                                              AccruedFireDamage;                                        // 0x0780(0x0004)
	float                                              UpsideDownDamagePerSec;                                   // 0x0784(0x0004)
	float                                              OccupiedUpsideDownDamagePerSec;                           // 0x0788(0x0004)
	float                                              WaterDamage;                                              // 0x078C(0x0004)
	float                                              AccumulatedWaterDamage;                                   // 0x0790(0x0004)
	TArray<int>                                        GroundEffectIndices;                                      // 0x0794(0x0010) (NeedCtorLink)
	float                                              MaxGroundEffectDist;                                      // 0x07A4(0x0004)
	struct FName                                       GroundEffectDistParameterName;                            // 0x07A8(0x0008)
	class UParticleSystem*                             WaterGroundEffect;                                        // 0x07B0(0x0008)
	struct FRotator                                    WeaponRotation;                                           // 0x07B8(0x000C) (Net)
	TArray<struct FVehicleSeat>                        Seats;                                                    // 0x07C4(0x0010) (Edit, Component, NeedCtorLink)
	int                                                SeatMask;                                                 // 0x07D4(0x0004) (Net)
	TArray<struct FVehicleAnim>                        VehicleAnims;                                             // 0x07D8(0x0010) (Edit, NeedCtorLink)
	TArray<struct FVehicleSound>                       VehicleSounds;                                            // 0x07E8(0x0010) (Edit, Component, NeedCtorLink)
	struct FName                                       DrivingAnim;                                              // 0x07F8(0x0008)
	float                                              DestroyOnPenetrationThreshold;                            // 0x0800(0x0004) (Edit)
	float                                              DestroyOnPenetrationDuration;                             // 0x0804(0x0004) (Edit)
	float                                              TimeInDestroyablePenetration;                             // 0x0808(0x0004)
	float                                              LastDeathImpactTime;                                      // 0x080C(0x0004)
	class USoundCue*                                   LargeChunkImpactSound;                                    // 0x0810(0x0008)
	class USoundCue*                                   MediumChunkImpactSound;                                   // 0x0818(0x0008)
	class USoundCue*                                   SmallChunkImpactSound;                                    // 0x0820(0x0008)
	float                                              CustomGravityScaling;                                     // 0x0828(0x0004) (Edit, Net)
	TArray<struct FDamageParamScales>                  DamageParamScaleLevels;                                   // 0x082C(0x0010) (NeedCtorLink)
	TArray<class UUDKSkelControl_Damage*>              DamageSkelControls;                                       // 0x083C(0x0010) (NeedCtorLink)
	TArray<struct FFDamageMorphTargets>                DamageMorphTargets;                                       // 0x084C(0x0010) (NeedCtorLink)
	class UMaterialInstanceConstant*                   DamageMaterialInstance[0x2];                              // 0x085C(0x0008)
	struct FUTTakeHitInfo                              LastTakeHitInfo;                                          // 0x086C(0x002C) (Net)
	float                                              LastTakeHitTimeout;                                       // 0x0898(0x0004)
	TArray<struct FVehicleEffect>                      VehicleEffects;                                           // 0x089C(0x0010) (Edit, Component, NeedCtorLink)
	class AController*                                 KillerController;                                         // 0x08AC(0x0008) (Net)
	float                                              LastJumpOutCheck;                                         // 0x08B4(0x0004)
	struct FName                                       WaterEffectType;                                          // 0x08B8(0x0008)
	TArray<int>                                        ContrailEffectIndices;                                    // 0x08C0(0x0010) (NeedCtorLink)
	struct FName                                       ContrailColorParameterName;                               // 0x08D0(0x0008)
	float                                              ObjectiveGetOutDist;                                      // 0x08D8(0x0004)
	TArray<class AUDKBot*>                             Trackers;                                                 // 0x08DC(0x0010) (NeedCtorLink)
	unsigned char                                      Team;                                                     // 0x08EC(0x0001) (Net)
	unsigned char                                      UnknownData00[0x3];                                       // 0x08ED(0x0003) MISSED OFFSET
	float                                              ExtraReachDownThreshold;                                  // 0x08F0(0x0004)
	float                                              ResetTime;                                                // 0x08F4(0x0004)
	float                                              MinRunOverSpeed;                                          // 0x08F8(0x0004)
	float                                              LastRunOverWarningTime;                                   // 0x08FC(0x0004)
	float                                              MinRunOverWarningAim;                                     // 0x0900(0x0004)
	float                                              TeamBeaconMaxDist;                                        // 0x0904(0x0004)
	float                                              LastPostRenderTraceTime;                                  // 0x0908(0x0004)
	float                                              ShowLockedMaxDist;                                        // 0x090C(0x0004)
	struct FVector                                     HUDLocation;                                              // 0x0910(0x000C)
	class UParticleSystemComponent*                    HoverboardDust;                                           // 0x091C(0x0008) (ExportObject, Component, EditInline)
...
// 0x0014 (0x0730 - 0x071C)
class AUDKWeaponPawn : public AUDKVehicleBase
{
public:
	class AUDKVehicle*                                 MyVehicle;                                                // 0x071C(0x0008) (Net)
	class AUDKWeapon*                                  MyVehicleWeapon;                                          // 0x0724(0x0008) (Net)
	int                                                MySeatIndex;                                              // 0x072C(0x0004) (Net)
...
{
public:
	struct FString                                     VehicleClassPath;                                         // 0x0358(0x0010) (NeedCtorLink)
	unsigned long                                      bHasLockedVehicle : 1;                                    // 0x0368(0x0004) (Net)
	unsigned long                                      bReplicateChildVehicle : 1;                               // 0x0368(0x0004)
	class UClass*                                      VehicleClass;                                             // 0x036C(0x0008)
	class AUDKVehicle*                                 ChildVehicle;                                             // 0x0374(0x0008) (Net)
	float                                              RespawnProgress;                                          // 0x037C(0x0004)
	struct FVector                                     HUDLocation;                                              // 0x0380(0x000C)
	int                                                TeamNum;                                                  // 0x038C(0x0004)
...
{
public:
	class UStaticMeshComponent*                        AirEffect;                                                // 0x0240(0x0008) (ExportObject, Component, EditInline)
	float                                              MinVelocityForAirEffect;                                  // 0x0248(0x0004)
	float                                              MaxVelocityForAirEffect;                                  // 0x024C(0x0004)
	struct FName                                       AirEffectScalar;                                          // 0x0250(0x0008)
	float                                              AirMaxDelta;                                              // 0x0258(0x0004)
	float                                              AirCurrentLevel;                                          // 0x025C(0x0004)
...
{
public:
	class UMeshComponent*                              OverlayMesh;                                              // 0x0384(0x0008) (ExportObject, Component, EditInline)
	unsigned long                                      bLeadTarget : 1;                                          // 0x038C(0x0004)
	unsigned long                                      bConsiderProjectileAcceleration : 1;                      // 0x038C(0x0004)
	int                                                AmmoCount;                                                // 0x0390(0x0004) (Net)
	unsigned char                                      HitEnemy;                                                 // 0x0394(0x0001) (Net)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0395(0x0003) MISSED OFFSET
	float                                              AimTraceRange;                                            // 0x0398(0x0004)
	TArray<class AActor*>                              AimingTraceIgnoredActors;                                 // 0x039C(0x0010) (NeedCtorLink)
...
{
public:
	unsigned long                                      bIgnoreFlaggedProjectiles : 1;                            // 0x0240(0x0004)
...
{
public:
	unsigned long                                      bAutoStart : 1;                                           // 0x0198(0x0004) (Edit)
	unsigned long                                      bLoopLastSequence : 1;                                    // 0x0198(0x0004)
	TArray<struct FName>                               SeqStack;                                                 // 0x019C(0x0010) (NeedCtorLink)
...
{
public:
	struct FName                                       DefaultAnim;                                              // 0x01AC(0x0008) (Edit)
	struct FName                                       DualPistolAnim;                                           // 0x01B4(0x0008) (Edit)
	struct FName                                       SinglePistolAnim;                                         // 0x01BC(0x0008) (Edit)
	struct FName                                       ShoulderRocketAnim;                                       // 0x01C4(0x0008) (Edit)
	struct FName                                       StingerAnim;                                              // 0x01CC(0x0008) (Edit)
...
{
public:
	struct FVector                                     WorldSpaceGoal;                                           // 0x0190(0x000C)
	struct FVector                                     InitialWorldSpaceGoalOffset;                              // 0x019C(0x000C) (Edit)
	struct FVector                                     Velocity;                                                 // 0x01A8(0x000C)
	float                                              SpringStiffness;                                          // 0x01B4(0x0004) (Edit)
	float                                              SpringDamping;                                            // 0x01B8(0x0004) (Edit)
	float                                              PercentBeamVelocityTransfer;                              // 0x01BC(0x0004) (Edit)
	struct FScriptDelegate                             __EntireBeamVelocity__Delegate;                           // 0x01C0(0x0010) (NeedCtorLink)
...
{
public:
	unsigned long                                      bInitialized : 1;                                         // 0x0124(0x0004)
	unsigned long                                      bOnDamageActive : 1;                                      // 0x0124(0x0004) (Edit)
	unsigned long                                      bControlStrFollowsHealth : 1;                             // 0x0124(0x0004) (Edit)
	unsigned long                                      bIsBroken : 1;                                            // 0x0124(0x0004) (Transient)
	unsigned long                                      bIsBreaking : 1;                                          // 0x0124(0x0004) (Transient)
	unsigned long                                      bOnDeathActive : 1;                                       // 0x0124(0x0004) (Edit)
	unsigned long                                      bOnDeathUseForSecondaryExplosion : 1;                     // 0x0124(0x0004) (Edit)
	class AUDKVehicle*                                 OwnerVehicle;                                             // 0x0128(0x0008)
	float                                              HealthPerc;                                               // 0x0130(0x0004)
	float                                              DamageBoneScale;                                          // 0x0134(0x0004) (Edit)
	int                                                DamageMax;                                                // 0x0138(0x0004) (Edit)
	float                                              ActivationThreshold;                                      // 0x013C(0x0004) (Edit)
	class UStaticMesh*                                 BreakMesh;                                                // 0x0140(0x0008) (Edit)
	float                                              BreakThreshold;                                           // 0x0148(0x0004) (Edit)
	float                                              BreakTime;                                                // 0x014C(0x0004) (Edit)
	struct FVector                                     DefaultBreakDir;                                          // 0x0150(0x000C) (Edit)
	struct FVector                                     DamageScale;                                              // 0x015C(0x000C) (Edit)
	class UParticleSystem*                             PS_DamageOnBreak;                                         // 0x0168(0x0008) (Edit)
	class UParticleSystem*                             PS_DamageTrail;                                           // 0x0170(0x0008) (Edit)
	struct FName                                       BrokenBone;                                               // 0x0178(0x0008) (Transient)
	float                                              BreakTimer;                                               // 0x0180(0x0004) (Transient)
	float                                              OwnerVehicleMaxHealth;                                    // 0x0184(0x0004) (Transient)
	struct FVector                                     BreakSpeed;                                               // 0x0188(0x000C) (Edit)
	float                                              DeathPercentToActuallySpawn;                              // 0x0194(0x0004) (Edit)
	float                                              DeathBoneScale;                                           // 0x0198(0x0004) (Edit)
	class UStaticMesh*                                 DeathStaticMesh;                                          // 0x019C(0x0008) (Edit)
	struct FVector                                     DeathImpulseDir;                                          // 0x01A4(0x000C) (Edit)
	struct FVector                                     DeathScale;                                               // 0x01B0(0x000C) (Edit)
	class UParticleSystem*                             PS_DeathOnBreak;                                          // 0x01BC(0x0008) (Edit)
	class UParticleSystem*                             PS_DeathTrail;                                            // 0x01C4(0x0008) (Edit)
...
{
public:
	float                                              MaxAngle;                                                 // 0x01CC(0x0004) (Edit)
	TEnumAsByte<EAxis>                                 PivotAxis;                                                // 0x01D0(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x01D1(0x0003) MISSED OFFSET
	float                                              AVModifier;                                               // 0x01D4(0x0004) (Edit)
	float                                              CurrentAngle;                                             // 0x01D8(0x0004) (Transient)
	float                                              SpringStiffness;                                          // 0x01DC(0x0004)
...
{
public:
	struct FRotator                                    MaxAngle;                                                 // 0x01CC(0x000C) (Edit)
	struct FRotator                                    MinAngle;                                                 // 0x01D8(0x000C) (Edit)
	float                                              Falloff;                                                  // 0x01E4(0x0004) (Edit)
	float                                              SpringStiffness;                                          // 0x01E8(0x0004) (Edit)
	float                                              AVModifier;                                               // 0x01EC(0x0004) (Edit)
	struct FRotator                                    CurrentAngle;                                             // 0x01F0(0x000C) (Transient)
	float                                              RandomPortion;                                            // 0x01FC(0x0004)
	struct FVector                                     LastHitMomentum;                                          // 0x0200(0x000C)
	float                                              LastHitTime;                                              // 0x020C(0x0004)
	float                                              MomentumPortion;                                          // 0x0210(0x0004)
...
{
public:
	float                                              TransIgnore;                                              // 0x0124(0x0004) (Edit)
	float                                              TransScale;                                               // 0x0128(0x0004) (Edit)
	float                                              TransOffset;                                              // 0x012C(0x0004) (Edit)
	float                                              MaxTrans;                                                 // 0x0130(0x0004) (Edit)
	float                                              MinTrans;                                                 // 0x0134(0x0004) (Edit)
	float                                              RotScale;                                                 // 0x0138(0x0004) (Edit)
	float                                              MaxRot;                                                   // 0x013C(0x0004) (Edit)
	float                                              MaxRotRate;                                               // 0x0140(0x0004) (Edit)
	float                                              CurrentRot;                                               // 0x0144(0x0004)
...
{
public:
	int                                                SwingHistoryWindow;                                       // 0x0124(0x0004) (Edit)
	int                                                SwingHistorySlot;                                         // 0x0128(0x0004)
	TArray<float>                                      SwingHistory;                                             // 0x012C(0x0010) (NeedCtorLink)
	float                                              SwingScale;                                               // 0x013C(0x0004) (Edit)
	float                                              MaxSwing;                                                 // 0x0140(0x0004) (Edit)
	float                                              MaxUseVel;                                                // 0x0144(0x0004) (Edit)
	float                                              CurrentSwing;                                             // 0x0148(0x0004)
...
{
public:
	float                                              VibFrequency;                                             // 0x0124(0x0004) (Edit)
	float                                              VibSpeedAmpScale;                                         // 0x0128(0x0004) (Edit)
	float                                              VibTurnAmpScale;                                          // 0x012C(0x0004) (Edit)
	float                                              VibMaxAmplitude;                                          // 0x0130(0x0004) (Edit)
	float                                              VibInput;                                                 // 0x0134(0x0004)
...
{
public:
	float                                              DesiredGroundDist;                                        // 0x0124(0x0004) (Edit)
	float                                              MaxDist;                                                  // 0x0128(0x0004) (Edit)
	struct FName                                       ParentBone;                                               // 0x012C(0x0008) (Edit)
	unsigned long                                      bOppositeFromParent : 1;                                  // 0x0134(0x0004) (Edit)
	float                                              XYDistFromParentBone;                                     // 0x0138(0x0004) (Edit)
	float                                              ZDistFromParentBone;                                      // 0x013C(0x0004) (Edit)
	float                                              MaxTranslationPerSec;                                     // 0x0140(0x0004) (Edit)
	float                                              LastUpdateTime;                                           // 0x0144(0x0004) (Transient)
...
{
public:
	unsigned long                                      bLockPitch : 1;                                           // 0x00F4(0x0004) (Edit)
	unsigned long                                      bLockYaw : 1;                                             // 0x00F4(0x0004) (Edit)
	unsigned long                                      bLockRoll : 1;                                            // 0x00F4(0x0004) (Edit)
	struct FRotator                                    LockRotation;                                             // 0x00F8(0x000C) (Edit)
	struct FRotator                                    MaxDelta;                                                 // 0x0104(0x000C) (Edit)
	TEnumAsByte<EBoneControlSpace>                     LockRotationSpace;                                        // 0x0110(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0111(0x0003) MISSED OFFSET
	struct FName                                       RotationSpaceBoneName;                                    // 0x0114(0x0008) (Edit)
...
{
public:
	unsigned long                                      bLimitYaw : 1;                                            // 0x0190(0x0004) (Edit)
	unsigned long                                      bLimitPitch : 1;                                          // 0x0190(0x0004) (Edit)
	unsigned long                                      bLimitRoll : 1;                                           // 0x0190(0x0004) (Edit)
	unsigned long                                      bShowPerAxisLimits : 1;                                   // 0x0190(0x0004) (Edit)
	float                                              YawLimit;                                                 // 0x0194(0x0004) (Edit)
	float                                              PitchLimit;                                               // 0x0198(0x0004) (Edit)
	float                                              RollLimit;                                                // 0x019C(0x0004) (Edit)
...
{
public:
	TArray<float>                                      BoneScales;                                               // 0x00F4(0x0010) (Edit, NeedCtorLink)
...
{
public:
	float                                              MaxRotationsPerSecond;                                    // 0x0124(0x0004) (Edit)
	float                                              SpinUpTime;                                               // 0x0128(0x0004) (Edit)
	unsigned long                                      bCounterClockwise : 1;                                    // 0x012C(0x0004) (Edit)
	float                                              RotationsPerSecond;                                       // 0x0130(0x0004)
	float                                              DesiredRotationsPerSecond;                                // 0x0134(0x0004)
...
{
public:
	struct FRotator                                    DesiredBoneRotation;                                      // 0x0124(0x000C) (Edit)
	struct FRotator                                    DesiredBoneRotationRate;                                  // 0x0130(0x000C) (Edit)
...
{
public:
	float                                              DegreesPerSecond;                                         // 0x0124(0x0004) (Edit)
	struct FVector                                     Axis;                                                     // 0x0128(0x000C) (Edit)
...
{
public:
	unsigned long                                      bConstrainPitch : 1;                                      // 0x0124(0x0004) (Edit)
	unsigned long                                      bConstrainYaw : 1;                                        // 0x0124(0x0004) (Edit)
	unsigned long                                      bConstrainRoll : 1;                                       // 0x0124(0x0004) (Edit)
	unsigned long                                      bInvertPitch : 1;                                         // 0x0124(0x0004) (Edit)
	unsigned long                                      bInvertYaw : 1;                                           // 0x0124(0x0004) (Edit)
	unsigned long                                      bInvertRoll : 1;                                          // 0x0124(0x0004) (Edit)
	unsigned long                                      bFixedWhenFiring : 1;                                     // 0x0124(0x0004) (Edit)
	unsigned long                                      bResetWhenUnattended : 1;                                 // 0x0124(0x0004) (Edit)
	unsigned long                                      bIsInMotion : 1;                                          // 0x0124(0x0004)
	struct FTurretConstraintData                       MaxAngle;                                                 // 0x0128(0x000C) (Edit)
	struct FTurretConstraintData                       MinAngle;                                                 // 0x0134(0x000C) (Edit)
	TArray<struct FTurretStepData>                     Steps;                                                    // 0x0140(0x0010) (Edit, NeedCtorLink)
	float                                              LagDegreesPerSecond;                                      // 0x0150(0x0004) (Edit)
	float                                              PitchSpeedScale;                                          // 0x0154(0x0004) (Edit)
	struct FRotator                                    DesiredBoneRotation;                                      // 0x0158(0x000C) (Edit)
	int                                                AssociatedSeatIndex;                                      // 0x0164(0x0004) (Edit)
	struct FRotator                                    ConstrainedBoneRotation;                                  // 0x0168(0x000C) (Transient)
	struct FScriptDelegate                             __OnTurretStatusChange__Delegate;                         // 0x0174(0x0010) (NeedCtorLink)
...
{
public:
	float                                              MaxPitch;                                                 // 0x0124(0x0004) (Edit)
	float                                              OldZPitch;                                                // 0x0128(0x0004)
	float                                              MaxPitchTime;                                             // 0x012C(0x0004)
	float                                              MaxPitchChange;                                           // 0x0130(0x0004)
	struct FName                                       RightFlapControl;                                         // 0x0134(0x0008)
	struct FName                                       LeftFlapControl;                                          // 0x013C(0x0008)
...
// 0x0040 (0x0594 - 0x0554)
class ASimplePawn : public AGamePawn
{
public:
	unsigned long                                      bFixedView : 1;                                           // 0x0554(0x0004)
	struct FVector                                     FixedViewLoc;                                             // 0x0558(0x000C)
	struct FRotator                                    FixedViewRot;                                             // 0x0564(0x000C)
	float                                              Bob;                                                      // 0x0570(0x0004)
	float                                              AppliedBob;                                               // 0x0574(0x0004)
	float                                              BobTime;                                                  // 0x0578(0x0004)
	struct FVector                                     WalkBob;                                                  // 0x057C(0x000C)
	float                                              OldZ;                                                     // 0x0588(0x0004)
	float                                              CastlePawnSpeed;                                          // 0x058C(0x0004) (Config)
	float                                              CastlePawnAccel;                                          // 0x0590(0x0004) (Config)
...
// 0x00FC (0x0844 - 0x0748)
class ASimplePC : public AGamePlayerController
{
public:
	float                                              AutoRotationAccelRate;                                    // 0x0748(0x0004)
	float                                              AutoRotationBrakeDecelRate;                               // 0x074C(0x0004)
	float                                              MaxAutoRotationVelocity;                                  // 0x0750(0x0004)
	float                                              BreathAutoRotationAccelRate;                              // 0x0754(0x0004)
	float                                              BreathAutoRotationBrakeDecelRate;                         // 0x0758(0x0004)
	float                                              MaxBreathAutoRotationVelocity;                            // 0x075C(0x0004)
	float                                              RangeBasedYawAccelStrength;                               // 0x0760(0x0004)
	float                                              RangeBasedAccelMaxDistance;                               // 0x0764(0x0004)
	unsigned long                                      bLookAtDestination : 1;                                   // 0x0768(0x0004)
	unsigned long                                      bCameraBreathing : 1;                                     // 0x0768(0x0004)
	unsigned long                                      bSmoothRotation : 1;                                      // 0x0768(0x0004) (Config)
	unsigned long                                      bApplyBackTouchToViewOffset : 1;                          // 0x0768(0x0004)
	unsigned long                                      bFingerIsDown : 1;                                        // 0x0768(0x0004)
	struct FVector                                     LookAtDestination;                                        // 0x076C(0x000C)
	float                                              LookAtDestAutoPitchAmount;                                // 0x0778(0x0004)
	struct FVector                                     CameraBreathCenterLocation;                               // 0x077C(0x000C)
	struct FRotator                                    CameraBreathRotator;                                      // 0x0788(0x000C)
	struct FVector                                     CameraBreathSampleLocation;                               // 0x0794(0x000C)
	float                                              LastCameraBreathDeltaSelectTime;                          // 0x07A0(0x0004)
	float                                              TimeBetweenCameraBreathChanges;                           // 0x07A4(0x0004)
	struct FVector2D                                   AutoRotationVelocity;                                     // 0x07A8(0x0008)
	struct FVector2D                                   ViewportSize;                                             // 0x07B0(0x0008)
	TArray<class USoundCue*>                           FootstepSounds;                                           // 0x07B8(0x0010) (NeedCtorLink)
	float                                              DistanceUntilNextFootstepSound;                           // 0x07C8(0x0004)
	struct FString                                     ServerCommandline;                                        // 0x07CC(0x0010) (Config, NeedCtorLink)
	float                                              OldTurn;                                                  // 0x07DC(0x0004)
	float                                              OldLookup;                                                // 0x07E0(0x0004)
	float                                              RotationSmoothingFactor;                                  // 0x07E4(0x0004) (Config)
	int                                                DefaultInputGroup;                                        // 0x07E8(0x0004) (Config)
	class UMobilePlayerInput*                          MPI;                                                      // 0x07EC(0x0008)
	class UMobileInputZone*                            SliderZone;                                               // 0x07F4(0x0008)
	class UMobileInputZone*                            StickMoveZone;                                            // 0x07FC(0x0008)
	class UMobileInputZone*                            StickLookZone;                                            // 0x0804(0x0008)
	class UMobileInputZone*                            FreeLookZone;                                             // 0x080C(0x0008)
	int                                                NoTapToMoves;                                             // 0x0814(0x0004)
	float                                              LastEnteredTapToMove;                                     // 0x0818(0x0004)
	float                                              TotalTimeInTapToMove;                                     // 0x081C(0x0004)
	float                                              TimeOfLastUserViewChange;                                 // 0x0820(0x0004)
	struct FVector2D                                   TouchCenter;                                              // 0x0824(0x0008)
	struct FRotator                                    LastOffset;                                               // 0x082C(0x000C)
	struct FRotator                                    MatineeOffset;                                            // 0x0838(0x000C)
...
{
public:
	unsigned long                                      bAllowAttractMode : 1;                                    // 0x049C(0x0004) (Config)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.CastleGame");
		return ptr;
	}
...
// 0x00A8 (0x08EC - 0x0844)
class ACastlePC : public ASimplePC
{
public:
	unsigned long                                      bSuppressSplash : 1;                                      // 0x0844(0x0004) (Config)
	unsigned long                                      bSplashHasBeenShown : 1;                                  // 0x0844(0x0004)
	unsigned long                                      bIsInAttractMode : 1;                                     // 0x0844(0x0004)
	unsigned long                                      bIsInBenchmarkMode : 1;                                   // 0x0844(0x0004)
	unsigned long                                      bBenchmarkLoopCompleted : 1;                              // 0x0844(0x0004)
	unsigned long                                      bDoneInitialFade : 1;                                     // 0x0844(0x0004)
	unsigned long                                      bPauseMenuOpen : 1;                                       // 0x0844(0x0004)
	unsigned long                                      bAutoSlide : 1;                                           // 0x0844(0x0004)
	int                                                BenchmarkNumFrames;                                       // 0x0848(0x0004)
	float                                              BenchmarkElapsedTime;                                     // 0x084C(0x0004)
	class UMobileMenuPause*                            PauseMenu;                                                // 0x0850(0x0008)
	class UMobileMenuDebug*                            DebugMenu;                                                // 0x0858(0x0008)
	float                                              SliderStart;                                              // 0x0860(0x0004)
	float                                              SliderEnd;                                                // 0x0864(0x0004)
	float                                              SliderTravelTime;                                         // 0x0868(0x0004)
	float                                              SliderTravelDuration;                                     // 0x086C(0x0004)
	float                                              AutoAttractTime;                                          // 0x0870(0x0004)
	class USoundCue*                                   OpenMenuSound;                                            // 0x0874(0x0008)
	class USoundCue*                                   CloseMenuSound;                                           // 0x087C(0x0008)
	class UMobileMenuControls*                         TutMenu;                                                  // 0x0884(0x0008)
	float                                              StuckThreshHold;                                          // 0x088C(0x0004)
	float                                              TapToMoveAutoPitchAmount;                                 // 0x0890(0x0004)
	class UStaticMesh*                                 TapToMoveVisualMesh;                                      // 0x0894(0x0008)
	float                                              TapToMoveVisualMinDist;                                   // 0x089C(0x0004)
	float                                              TapToMoveVisualRotateSpeed;                               // 0x08A0(0x0004)
	float                                              TapToMoveVisualAnimDuration;                              // 0x08A4(0x0004)
	struct FVector                                     TapToMoveDestination;                                     // 0x08A8(0x000C)
	float                                              LastDistToDestination;                                    // 0x08B4(0x0004)
	float                                              TapToMoveVisualEffectStartTime;                           // 0x08B8(0x0004)
	float                                              TapToMoveVisualEffectEndTime;                             // 0x08BC(0x0004)
	class USoundCue*                                   TapToMoveSound;                                           // 0x08C0(0x0008)
	class USoundCue*                                   InvalidTapToMoveSound;                                    // 0x08C8(0x0008)
	class USoundCue*                                   TapToMoveStopSound;                                       // 0x08D0(0x0008)
	class AKActorSpawnable*                            TapToMoveVisualActor;                                     // 0x08D8(0x0008)
	TEnumAsByte<ETutorialStage>                        TutorialStage;                                            // 0x08E0(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x08E1(0x0003) MISSED OFFSET
	class UMobileInputZone*                            TutorialLookZone;                                         // 0x08E4(0x0008)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.CastlePC");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.MobileMenuControls");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.MobileMenuBase");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.MobileMenuDebug");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.MobileMenuPause");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.MobileMenuSplash");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.CloudGame");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.CloudHUD");
		return ptr;
	}
...
// 0x003C (0x0880 - 0x0844)
class ACloudPC : public ASimplePC
{
public:
	class UCloudSaveData*                              SaveData;                                                 // 0x0844(0x0008)
	int                                                Slot1DocIndex;                                            // 0x084C(0x0004)
	int                                                Slot2DocIndex;                                            // 0x0850(0x0004)
	class UCloudStorageBase*                           Cloud;                                                    // 0x0854(0x0008)
	class UFacebookIntegration*                        Facebook;                                                 // 0x085C(0x0008)
	class UInGameAdManager*                            AdManager;                                                // 0x0864(0x0008)
	class UMicroTransactionBase*                       MicroTrans;                                               // 0x086C(0x0008)
	class UTwitterIntegrationBase*                     Twitter;                                                  // 0x0874(0x0008)
	unsigned long                                      bIsFBAuthenticating : 1;                                  // 0x087C(0x0004)
	unsigned long                                      bAdHasBeenShown : 1;                                      // 0x087C(0x0004)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.CloudPC");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.CloudSaveData");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.CloudMenuMicroTrans");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.MobileGameCrowdAgent");
		return ptr;
	}
...
public:
	...
	struct FVector                                     FixedViewLoc;                                             // 0x0558(0x000C)
	struct FRotator                                    FixedViewRot;                                             // 0x0564(0x000C)
	class ULightEnvironmentComponent*                  LightEnvironment;                                         // 0x0570(0x0008) (Edit, Const, ExportObject, EditConst, Component, EditInline)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.MobilePlaceablePawn");
		return ptr;
	}
...
{
public:
	float                                              AccelRate;                                                // 0x029C(0x0004) (Edit)
	unsigned long                                      bShuttingDown : 1;                                        // 0x02A0(0x0004)
	unsigned long                                      bInitOnSpawnWithRotation : 1;                             // 0x02A0(0x0004) (Edit)
	unsigned long                                      bSuppressExplosionFX : 1;                                 // 0x02A0(0x0004)
	class UParticleSystemComponent*                    ProjEffects;                                              // 0x02A4(0x0008) (ExportObject, Component, EditInline)
	class UParticleSystem*                             ProjFlightTemplate;                                       // 0x02AC(0x0008) (Edit)
	class UParticleSystem*                             ProjExplosionTemplate;                                    // 0x02B4(0x0008) (Edit)
	float                                              MaxEffectDistance;                                        // 0x02BC(0x0004) (Edit)
	class USoundCue*                                   ExplosionSound;                                           // 0x02C0(0x0008) (Edit)
	TArray<class UClass*>                              ActorsToIgnoreWhenHit;                                    // 0x02C8(0x0010) (Edit, NeedCtorLink)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.MobileProjectile");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.SeqAct_MobileCrowdSpawner");
		return ptr;
	}
...
{
public:
	struct FName                                       BoneName;                                                 // 0x0198(0x0008) (Edit)
	TEnumAsByte<EAxis>                                 BoneAxis;                                                 // 0x01A0(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x01A1(0x0003) MISSED OFFSET
	TArray<struct FAnimByRotation>                     AnimList;                                                 // 0x01A4(0x0010) (Edit, NeedCtorLink)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UDKBase.UDKMobileInputZone");
		return ptr;
	}

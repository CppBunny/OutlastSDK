...
{
public:
	unsigned long                                      bAutoPlay : 1;                                            // 0x0248(0x0004) (Edit)
	unsigned long                                      bStopPending : 1;                                         // 0x0248(0x0004)
	unsigned long                                      StopWhenOwnerIsDestroyed : 1;                             // 0x0248(0x0004) (Edit)
	unsigned long                                      bIsPlaying : 1;                                           // 0x0248(0x0004) (Transient)
	class UAkEvent*                                    PlayEvent;                                                // 0x024C(0x0008) (Edit)
...
{
public:
	unsigned char                                      UnknownData00[0x6C];                                      // 0x0068(0x006C) MISSED OFFSET
...
{
public:
	struct FName                                       BoneName;                                                 // 0x00C0(0x0008) (Edit)
...
{
public:
	struct FName                                       BoneName;                                                 // 0x0150(0x0008) (Edit)

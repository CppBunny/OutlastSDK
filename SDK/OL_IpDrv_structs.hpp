...
{
	struct FUniqueNetId                                PlayerNetId;                                              // 0x0000(0x0010)
	TEnumAsByte<ENATType>                              NatType;                                                  // 0x0010(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
	unsigned long                                      bCanHostVs : 1;                                           // 0x0014(0x0004)
	float                                              GoodHostRatio;                                            // 0x0018(0x0004)
	TArray<struct FConnectionBandwidthStats>           BandwidthHistory;                                         // 0x001C(0x0010) (NeedCtorLink)
	int                                                MinutesSinceLastTest;                                     // 0x002C(0x0004)
};
...
{
	struct FUniqueNetId                                PlayerNetId;                                              // 0x0000(0x0010)
	float                                              ElapsedHeartbeatTime;                                     // 0x0010(0x0004)
	struct FPointer                                    Socket;                                                   // 0x0014(0x0008) (Native, Transient)
	unsigned long                                      bConnectionAccepted : 1;                                  // 0x001C(0x0004)
	struct FClientConnectionBandwidthTestData          BandwidthTest;                                            // 0x0020(0x0028)
	...
	TArray<struct FConnectionBandwidthStats>           BandwidthHistory;                                         // 0x0054(0x0010) (NeedCtorLink)
...
{
	struct FUniqueNetId                                NetId;                                                    // 0x0000(0x0010)
	int                                                Skill;                                                    // 0x0010(0x0004)
	int                                                XpLevel;                                                  // 0x0014(0x0004)
	struct FDouble                                     Mu;                                                       // 0x0018(0x0008)
	struct FDouble                                     Sigma;                                                    // 0x0020(0x0008)
	float                                              ElapsedSessionTime;                                       // 0x0028(0x0004)
};
...
{
	int                                                TeamNum;                                                  // 0x0000(0x0004)
	struct FUniqueNetId                                PartyLeader;                                              // 0x0004(0x0010)
	TArray<struct FPlayerReservation>                  PartyMembers;                                             // 0x0014(0x0010) (NeedCtorLink)
};

...
{
public:
	TEnumAsByte<ELinkMode>                             LinkMode;                                                 // 0x0240(0x0001)
	TEnumAsByte<ELineMode>                             InLineMode;                                               // 0x0241(0x0001)
	TEnumAsByte<ELineMode>                             OutLineMode;                                              // 0x0242(0x0001)
	TEnumAsByte<EReceiveMode>                          ReceiveMode;                                              // 0x0243(0x0001)
	struct FPointer                                    Socket;                                                   // 0x0244(0x0008) (Const)
	int                                                Port;                                                     // 0x024C(0x0004) (Const)
	struct FPointer                                    RemoteSocket;                                             // 0x0250(0x0008) (Const)
	struct FPointer                                    PrivateResolveInfo;                                       // 0x0258(0x0008) (Const, Native)
	int                                                DataPending;                                              // 0x0260(0x0004) (Const)
...
{
public:
	TEnumAsByte<ELinkState>                            LinkState;                                                // 0x0264(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0265(0x0003) MISSED OFFSET
	struct FIpAddr                                     RemoteAddr;                                               // 0x0268(0x0008)
	class UClass*                                      AcceptClass;                                              // 0x0270(0x0008)
	TArray<unsigned char>                              SendFIFO;                                                 // 0x0278(0x0010) (Const, NeedCtorLink)
	struct FString                                     RecvBuf;                                                  // 0x0288(0x0010) (Const, NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnReadNewsCompleted__Delegate;                          // 0x00A4(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnReadTitleFileComplete__Delegate;                      // 0x00E4(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnRequestTitleFileListComplete__Delegate;               // 0x00F4(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnLoadTitleFileComplete__Delegate;                      // 0x00B0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnSaveTitleFileComplete__Delegate;                      // 0x00C0(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnCreateMessageComplete__Delegate;                      // 0x00AC(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDeleteMessageComplete__Delegate;                      // 0x00BC(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryMessagesComplete__Delegate;                      // 0x00CC(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryMessageContentsComplete__Delegate;               // 0x00DC(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnEnumerateUserFilesComplete__Delegate;                 // 0x0108(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnReadUserFileComplete__Delegate;                       // 0x0118(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnWriteUserFileComplete__Delegate;                      // 0x0128(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDeleteUserFileComplete__Delegate;                     // 0x0138(0x0010) (NeedCtorLink)
...
public:
	...
	float                                              ConnectionRequestTimeout;                                 // 0x00FC(0x0004) (Config)
	float                                              ConnectionRequestElapsedTime;                             // 0x0100(0x0004)
	struct FString                                     ResolverClassName;                                        // 0x0104(0x0010) (Config, NeedCtorLink)
	class UClass*                                      ResolverClass;                                            // 0x0114(0x0008)
	class UClientBeaconAddressResolver*                Resolver;                                                 // 0x011C(0x0008)
	unsigned long                                      bUsingRegisteredAddr : 1;                                 // 0x0124(0x0004) (Transient)
	struct FScriptDelegate                             __OnConnectionRequestResult__Delegate;                    // 0x0128(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnReceivedBandwidthTestRequest__Delegate;               // 0x0138(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnReceivedBandwidthTestResults__Delegate;               // 0x0148(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnTravelRequestReceived__Delegate;                      // 0x0158(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnCreateNewSessionRequestReceived__Delegate;            // 0x0168(0x0010) (NeedCtorLink)
...
public:
	...
	struct FUniqueNetId                                OwningPlayerId;                                           // 0x00C4(0x0010) (Const)
	unsigned long                                      bAllowBandwidthTesting : 1;                               // 0x00D4(0x0004)
	int                                                ConnectionBacklog;                                        // 0x00D8(0x0004) (Config)
	struct FScriptDelegate                             __OnReceivedClientConnectionRequest__Delegate;            // 0x00DC(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnStartedBandwidthTest__Delegate;                       // 0x00EC(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnFinishedBandwidthTest__Delegate;                      // 0x00FC(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnAllPendingPlayersConnected__Delegate;                 // 0x010C(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnReceivedClientCreateNewSessionResult__Delegate;       // 0x011C(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnAuthReady__Delegate;                                  // 0x0274(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnClientAuthRequest__Delegate;                          // 0x0284(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnServerAuthRequest__Delegate;                          // 0x0294(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnClientAuthResponse__Delegate;                         // 0x02A4(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnServerAuthResponse__Delegate;                         // 0x02B4(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnClientAuthComplete__Delegate;                         // 0x02C4(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnServerAuthComplete__Delegate;                         // 0x02D4(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnClientAuthEndSessionRequest__Delegate;                // 0x02E4(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnServerAuthRetryRequest__Delegate;                     // 0x02F4(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnClientConnectionClose__Delegate;                      // 0x0304(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnServerConnectionClose__Delegate;                      // 0x0314(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnFindOnlineGamesComplete__Delegate;                    // 0x0158(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnCreateOnlineGameComplete__Delegate;                   // 0x0168(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnUpdateOnlineGameComplete__Delegate;                   // 0x0178(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDestroyOnlineGameComplete__Delegate;                  // 0x0188(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnCancelFindOnlineGamesComplete__Delegate;              // 0x0198(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnJoinOnlineGameComplete__Delegate;                     // 0x01A8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnRegisterPlayerComplete__Delegate;                     // 0x01B8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnUnregisterPlayerComplete__Delegate;                   // 0x01C8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnStartOnlineGameComplete__Delegate;                    // 0x01D8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnEndOnlineGameComplete__Delegate;                      // 0x01E8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnArbitrationRegistrationComplete__Delegate;            // 0x01F8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnGameInviteAccepted__Delegate;                         // 0x0208(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnRecalculateSkillRatingComplete__Delegate;             // 0x0218(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnMigrateOnlineGameComplete__Delegate;                  // 0x0228(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnJoinMigratedOnlineGameComplete__Delegate;             // 0x0238(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQosStatusChanged__Delegate;                           // 0x0248(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnReadPlaylistComplete__Delegate;                       // 0x0110(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnPlaylistPopulationDataUpdated__Delegate;              // 0x0120(0x0010) (NeedCtorLink)
...
public:
	...
	float                                              ElapsedHeartbeatTime;                                     // 0x007C(0x0004)
	struct FName                                       BeaconName;                                               // 0x0080(0x0008)
	struct FScriptDelegate                             __OnDestroyComplete__Delegate;                            // 0x0088(0x0010) (NeedCtorLink)
...
public:
	...
	struct FPartyReservation                           PendingRequest;                                           // 0x00A8(0x0024) (NeedCtorLink)
	...
	float                                              ReservationRequestTimeout;                                // 0x00D0(0x0004) (Config)
	float                                              ReservationRequestElapsedTime;                            // 0x00D4(0x0004)
	struct FString                                     ResolverClassName;                                        // 0x00D8(0x0010) (Config, NeedCtorLink)
	class UClass*                                      ResolverClass;                                            // 0x00E8(0x0008)
	class UClientBeaconAddressResolver*                Resolver;                                                 // 0x00F0(0x0008)
	struct FScriptDelegate                             __OnReservationRequestComplete__Delegate;                 // 0x00F8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnReservationCountUpdated__Delegate;                    // 0x0108(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnTravelRequestReceived__Delegate;                      // 0x0118(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnHostIsReady__Delegate;                                // 0x0128(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnHostHasCancelled__Delegate;                           // 0x0138(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnReservationChange__Delegate;                          // 0x00E4(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnReservationsFull__Delegate;                           // 0x00F4(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnClientCancellationReceived__Delegate;                 // 0x0104(0x0010) (NeedCtorLink)
...
// 0x0024 (0xB0F4 - 0xB0D0)
class UTcpipConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x24];                                      // 0xB0D0(0x0024) MISSED OFFSET
...
{
public:
	unsigned long                                      AllowPlayerPortUnreach : 1;                               // 0x01F4(0x0004) (Config)
	unsigned long                                      UnknownData00 : 31;                                       // 0x01F4(0x0001)
	unsigned long                                      LogPortUnreach : 1;                                       // 0x01F8(0x0004) (Config)
	unsigned char                                      UnknownData01[0x18];                                      // 0x01FC(0x0018) MISSED OFFSET
...
{
public:
	struct FString                                     ServerName;                                               // 0x0298(0x0010) (Config, NeedCtorLink)
	struct FString                                     Applications[0xA];                                        // 0x02A8(0x0010) (Config, NeedCtorLink)
	struct FString                                     ApplicationPaths[0xA];                                    // 0x0348(0x0010) (Config, NeedCtorLink)
	unsigned long                                      bEnabled : 1;                                             // 0x03E8(0x0004) (Config)
	int                                                ListenPort;                                               // 0x03EC(0x0004) (Config)
	int                                                MaxConnections;                                           // 0x03F0(0x0004) (Config)
	int                                                DefaultApplication;                                       // 0x03F4(0x0004) (Config)
	int                                                ExpirationSeconds;                                        // 0x03F8(0x0004) (Config)
	struct FString                                     ServerURL;                                                // 0x03FC(0x0010) (NeedCtorLink)
	class UWebApplication*                             ApplicationObjects[0xA];                                  // 0x040C(0x0008)
	int                                                ConnectionCount;                                          // 0x045C(0x0004)
	int                                                ConnID;                                                   // 0x0460(0x0004)
...
public:
	...
	struct FScriptDelegate                             __OnQueryChallengeListComplete__Delegate;                 // 0x0088(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDownloadChallengeFileComplete__Delegate;              // 0x0098(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnAcceptChallengeComplete__Delegate;                    // 0x00A8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryChallengeUserStatusComplete__Delegate;           // 0x00B8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnUpdateChallengeUserProgressComplete__Delegate;        // 0x00C8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnUpdateChallengeUserRewardComplete__Delegate;          // 0x00D8(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnCreateGroupComplete__Delegate;                        // 0x0098(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDeleteGroupComplete__Delegate;                        // 0x00A8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryGroupsComplete__Delegate;                        // 0x00B8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryGroupMembersComplete__Delegate;                  // 0x00C8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnAddGroupMembersComplete__Delegate;                    // 0x00D8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnRemoveGroupMembersComplete__Delegate;                 // 0x00E8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDeleteAllGroupsComplete__Delegate;                    // 0x00F8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryGroupInvitesComplete__Delegate;                  // 0x0108(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnAcceptGroupInviteComplete__Delegate;                  // 0x0118(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnQueryGroupsRequestComplete__Delegate;                 // 0x01B8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryGroupMembersRequestComplete__Delegate;           // 0x01C8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnAddGroupMembersRequestComplete__Delegate;             // 0x01D8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnAcceptGroupInviteRequestComplete__Delegate;           // 0x01E8(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnAddMappingComplete__Delegate;                         // 0x0088(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryMappingsComplete__Delegate;                      // 0x0098(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnCreateSaveSlotComplete__Delegate;                     // 0x0088(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnReadSaveSlotComplete__Delegate;                       // 0x0098(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnUpdateValueComplete__Delegate;                        // 0x00A8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDeleteValueComplete__Delegate;                        // 0x00B8(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnQueryServerTimeComplete__Delegate;                    // 0x0088(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnCreateSaveSlotComplete__Delegate;                     // 0x0088(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDeleteSaveSlotComplete__Delegate;                     // 0x0098(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQuerySaveSlotListComplete__Delegate;                  // 0x00A8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryInventoryItemsComplete__Delegate;                // 0x00B8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnPurchaseItemComplete__Delegate;                       // 0x00C8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnSellItemComplete__Delegate;                           // 0x00D8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnEarnItemComplete__Delegate;                           // 0x00E8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnConsumeItemComplete__Delegate;                        // 0x00F8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDeleteItemComplete__Delegate;                         // 0x0108(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnRecordIapComplete__Delegate;                          // 0x0118(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnRegisterUserComplete__Delegate;                       // 0x0088(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnAuthenticateUserComplete__Delegate;                   // 0x0098(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryUsersComplete__Delegate;                         // 0x00A8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDeleteUserComplete__Delegate;                         // 0x00B8(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnOnlineImageDownloaded__Delegate;                      // 0x0074(0x0010) (NeedCtorLink)
...
{
public:
	class AWebServer*                                  WebServer;                                                // 0x0298(0x0008)
	struct FString                                     ReceivedData;                                             // 0x02A0(0x0010) (NeedCtorLink)
	class UWebRequest*                                 Request;                                                  // 0x02B0(0x0008)
	class UWebResponse*                                Response;                                                 // 0x02B8(0x0008)
	class UWebApplication*                             Application;                                              // 0x02C0(0x0008)
	unsigned long                                      bDelayCleanup : 1;                                        // 0x02C8(0x0004)
	int                                                RawBytesExpecting;                                        // 0x02CC(0x0004)
	int                                                MaxValueLength;                                           // 0x02D0(0x0004) (Config)
	int                                                MaxLineLength;                                            // 0x02D4(0x0004) (Config)
	int                                                ConnID;                                                   // 0x02D8(0x0004)

...
// Parameters:
// struct FColor                  _FadeColor                     (Parm)
// unsigned char                  _FromAlpha                     (Parm)
// unsigned char                  _ToAlpha                       (Parm)
// float                          _FadeTime                      (Parm)

void AGamePlayerController::ClientColorFade(const struct FColor& _FadeColor, unsigned char _FromAlpha, unsigned char _ToAlpha, float _FadeTime)
{
	...
	params._FromAlpha = _FromAlpha;
	params._ToAlpha = _ToAlpha;

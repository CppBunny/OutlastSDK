...
// Enum Engine.Actor.FaceFXPriority
enum class EFaceFXPriority : uint8_t
{
	FFXP_None                      = 0,
	FFXP_Low                       = 1,
	FFXP_Normal                    = 2,
...
// Enum Engine.AkEvent.EVO_Behavior
enum class EVO_Behavior : uint8_t
{
	EVOB_Cancel                    = 0,
	EVOB_PauseAndResume            = 1,
	EVOB_WaitToFinish              = 2,
	EVOB_MAX                       = 3
};


// Enum Engine.AkEvent.EEventValid
enum class EEventValid : uint8_t
{
	EEV_Valid                      = 0,
	EEV_Deleted                    = 1,
	EEV_MAX                        = 2
...
// Enum Engine.HeadTrackingComponent.HeadTrackingState
enum class EHeadTrackingState : uint8_t
{
	HS_Unaware                     = 0,
	HS_Looking                     = 1,
	HS_TooLong                     = 2,
...
enum class EProfileSettingID : uint8_t
{
	...
	PSI_GammaSetting               = 28,
	PSI_TextureQuality             = 29,
	PSI_ShadowsQuality             = 30,
	PSI_EffectsQuality             = 31,
	PSI_VSync                      = 32,
	PSI_Fullscreen                 = 33,
	PSI_Resolution                 = 34,
	PSI_GamepadConfig              = 35,
	PSI_KB_MoveForward             = 36,
	PSI_KB_MoveBackward            = 37,
	PSI_KB_TurnLeft                = 38,
	PSI_KB_TurnRight               = 39,
	PSI_KB_StrafeLeft              = 40,
	PSI_KB_StrafeRight             = 41,
	PSI_KB_Crouch                  = 42,
	PSI_KB_Use                     = 43,
	PSI_KB_Run                     = 44,
	PSI_KB_ToggleCamcorder         = 45,
	PSI_KB_ToggleNightVision       = 46,
	PSI_KB_LeanLeft                = 47,
	PSI_KB_LeanRight               = 48,
	PSI_KB_ZoomImpulseIn           = 49,
	PSI_KB_ZoomImpulseOut          = 50,
	PSI_KB_Reload                  = 51,
	PSI_KB_Jump                    = 52,
	PSI_KB_ShowMenu                = 53,
	PSI_KB_ShowTabMenu             = 54,
	PSI_KB_ShowRecordingMenu       = 55,
	PSI_KB_ShowEvidenceMenu        = 56,
	PSI_Volume                     = 57,
	PSI_Subtitles                  = 58,
	PSI_Tutorials                  = 59,
	PSI_ShowCrosshair              = 60,
	PSI_Language                   = 61,
	PSI_GammaInitialized           = 62,
	PSI_ToggleCrouch               = 63,
	PSI_ShowPrompts                = 64,
	PSI_FinishedGame               = 65,
	PSI_Southpaw                   = 66,
...
// Enum Engine.OnlineProfileSettings.EProfileSettingBoolean
enum class EProfileSettingBoolean : uint8_t
{
	PSB_Off                        = 0,
	PSB_On                         = 1,
	PSB_MAX                        = 2
...
struct FPostProcessSettings
{
	...
	struct FMobilePostProcessSettings                  MobilePostProcess;                                        // 0x012C(0x0034) (Edit)
};
...
struct FUniqueNetId
{
	...
	struct FQWord                                      UidHigh;                                                  // 0x0008(0x0008)
};
...
{
	struct FUniqueNetId                                PlayerNetId;                                              // 0x0000(0x0010) (Const)
};
...
{
	struct FQWord                                      MachineId;                                                // 0x0010(0x0008) (Const)
	int                                                Trustworthiness;                                          // 0x0018(0x0004) (Const)
};
...
struct FLightingChannelContainer
{
	...
	unsigned long                                      Dynamic_2 : 1;                                            // 0x0000(0x0004) (Edit)
	unsigned long                                      Dynamic_3 : 1;                                            // 0x0000(0x0004) (Edit)
	unsigned long                                      Dynamic_4 : 1;                                            // 0x0000(0x0004) (Edit)
	unsigned long                                      Dynamic_5 : 1;                                            // 0x0000(0x0004) (Edit)
	unsigned long                                      Dynamic_6 : 1;                                            // 0x0000(0x0004) (Edit)
...
{
	struct FUniqueNetId                                PlayerID;                                                 // 0x0000(0x0010)
	TEnumAsByte<ENATType>                              NatType;                                                  // 0x0010(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
	unsigned long                                      bLostConnectionToHost : 1;                                // 0x0014(0x0004)
};
...
struct FGameSessionInformation
{
	...
	struct FUniqueNetId                                OwningNetId;                                              // 0x007C(0x0010) (Const)
	int                                                PlaylistId;                                               // 0x008C(0x0004)
};
...
struct FPlayerInformation
{
	...
	struct FUniqueNetId                                UniqueId;                                                 // 0x0018(0x0010)
	unsigned long                                      bIsBot : 1;                                               // 0x0028(0x0004)
};
...
struct FBaseAuthSession
{
	...
	struct FUniqueNetId                                EndPointUID;                                              // 0x0008(0x0010) (Const)
};
...
{
	int                                                SessionUID;                                               // 0x0018(0x0004) (Const)
};
...
{
	TEnumAsByte<EAuthStatus>                           AuthStatus;                                               // 0x0018(0x0001) (Const)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0019(0x0003) MISSED OFFSET
	int                                                AuthTicketUID;                                            // 0x001C(0x0004) (Const)
};
...
{
	struct FUniqueNetId                                PlayerID;                                                 // 0x0000(0x0010) (Const)
	struct FSettingsData                               Rank;                                                     // 0x0010(0x0010) (Const)
	struct FString                                     NickName;                                                 // 0x0020(0x0010) (Const, NeedCtorLink)
	TArray<struct FOnlineStatsColumn>                  Columns;                                                  // 0x0030(0x0010) (NeedCtorLink)
};
...
{
	struct FPostProcessSettings                        LastSettings;                                             // 0x0000(0x0160) (NeedCtorLink)
	class APostProcessVolume*                          LastVolumeUsed;                                           // 0x0160(0x0008)
	float                                              BlendStartTime;                                           // 0x0168(0x0004)
	float                                              LastBlendTime;                                            // 0x016C(0x0004)
};
...
{
	struct FPostProcessSettings                        Settings;                                                 // 0x0000(0x0160) (NeedCtorLink)
	unsigned long                                      bBlendingIn : 1;                                          // 0x0160(0x0004)
	unsigned long                                      bBlendingOut : 1;                                         // 0x0160(0x0004)
	float                                              CurrentBlendInTime;                                       // 0x0164(0x0004)
	float                                              CurrentBlendOutTime;                                      // 0x0168(0x0004)
	float                                              BlendInDuration;                                          // 0x016C(0x0004)
	float                                              BlendOutDuration;                                         // 0x0170(0x0004)
	float                                              BlendStartTime;                                           // 0x0174(0x0004)
	struct FInterpCurveFloat                           TimeAlphaCurve;                                           // 0x0178(0x0014) (NeedCtorLink)
};
...
struct FSoundEventMapping
{
	...
	class UAkBaseSoundObject*                          SoundToPlay;                                              // 0x0008(0x0008) (Edit)
};
...
{
	struct FUniqueNetId                                SendingPlayerId;                                          // 0x0000(0x0010)
	struct FString                                     SendingPlayerNick;                                        // 0x0010(0x0010) (NeedCtorLink)
	unsigned long                                      bIsFriendInvite : 1;                                      // 0x0020(0x0004)
	unsigned long                                      bIsGameInvite : 1;                                        // 0x0020(0x0004)
	unsigned long                                      bWasAccepted : 1;                                         // 0x0020(0x0004)
	unsigned long                                      bWasDenied : 1;                                           // 0x0020(0x0004)
	struct FString                                     Message;                                                  // 0x0024(0x0010) (NeedCtorLink)
};
...
{
	struct FUniqueNetId                                UniqueId;                                                 // 0x0000(0x0010) (Const)
	struct FQWord                                      SessionId;                                                // 0x0010(0x0008) (Const)
	struct FString                                     NickName;                                                 // 0x0018(0x0010) (Const, NeedCtorLink)
	struct FString                                     PresenceInfo;                                             // 0x0028(0x0010) (Const, NeedCtorLink)
	TEnumAsByte<EOnlineFriendState>                    FriendState;                                              // 0x0038(0x0001) (Const)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0039(0x0003) MISSED OFFSET
	unsigned long                                      bIsOnline : 1;                                            // 0x003C(0x0004) (Const)
	unsigned long                                      bIsPlaying : 1;                                           // 0x003C(0x0004) (Const)
	unsigned long                                      bIsPlayingThisGame : 1;                                   // 0x003C(0x0004) (Const)
	unsigned long                                      bIsJoinable : 1;                                          // 0x003C(0x0004) (Const)
	unsigned long                                      bHasVoiceSupport : 1;                                     // 0x003C(0x0004) (Const)
	unsigned long                                      bHaveInvited : 1;                                         // 0x003C(0x0004)
	unsigned long                                      bHasInvitedYou : 1;                                       // 0x003C(0x0004) (Const)
};
...
struct FOnlinePartyMember
{
	...
	unsigned char                                      LocalUserNum;                                             // 0x0020(0x0001) (Const)
	TEnumAsByte<ENATType>                              NatType;                                                  // 0x0021(0x0001) (Const)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0022(0x0002) MISSED OFFSET
	int                                                TitleId;                                                  // 0x0024(0x0004) (Const)
	unsigned long                                      bIsLocal : 1;                                             // 0x0028(0x0004) (Const)
	unsigned long                                      bIsInPartyVoice : 1;                                      // 0x0028(0x0004) (Const)
	unsigned long                                      bIsTalking : 1;                                           // 0x0028(0x0004) (Const)
	unsigned long                                      bIsInGameSession : 1;                                     // 0x0028(0x0004) (Const)
	unsigned long                                      bIsPlayingThisGame : 1;                                   // 0x0028(0x0004) (Const)
	struct FQWord                                      SessionId;                                                // 0x002C(0x0008) (Const)
	int                                                Data1;                                                    // 0x0034(0x0004) (Const)
	int                                                Data2;                                                    // 0x0038(0x0004) (Const)
	int                                                Data3;                                                    // 0x003C(0x0004) (Const)
	int                                                Data4;                                                    // 0x0040(0x0004) (Const)
};
...
{
	struct FUniqueNetId                                UniqueId;                                                 // 0x0000(0x0010)
	unsigned long                                      bIsFriend : 1;                                            // 0x0010(0x0004)
};
...
struct FCommunityContentFile
{
	...
	struct FUniqueNetId                                Owner;                                                    // 0x0010(0x0010)
	int                                                DownloadCount;                                            // 0x0020(0x0004)
	float                                              AverageRating;                                            // 0x0024(0x0004)
	int                                                RatingCount;                                              // 0x0028(0x0004)
	int                                                LastRatingGiven;                                          // 0x002C(0x0004)
	struct FString                                     LocalFilePath;                                            // 0x0030(0x0010) (NeedCtorLink)
};
...
{
	struct FUniqueNetId                                TalkerId;                                                 // 0x0000(0x0010)
	float                                              LastNotificationTime;                                     // 0x0010(0x0004)
	unsigned long                                      bWasTalking : 1;                                          // 0x0014(0x0004)
	unsigned long                                      bIsTalking : 1;                                           // 0x0014(0x0004)
	unsigned long                                      bIsRegistered : 1;                                        // 0x0014(0x0004)
};
...
struct FPendingClientAuth
{
	...
	struct FUniqueNetId                                ClientUID;                                                // 0x0008(0x0010)
	float                                              AuthTimestamp;                                            // 0x0018(0x0004)
	int                                                AuthRetryCount;                                           // 0x001C(0x0004)
};
...
{
	struct FUniqueNetId                                ClientUID;                                                // 0x0000(0x0010)
	int                                                AuthRetryCount;                                           // 0x0010(0x0004)
};
...
struct FActorToLookAt
{
	...
	float                                              DisinterestedStartedTime;                                 // 0x001C(0x0004)
	float                                              TimeStoppedBeingLookedAt;                                 // 0x0020(0x0004)
	float                                              CurrentControlStrength;                                   // 0x0024(0x0004)
	TEnumAsByte<EHeadTrackingState>                    State;                                                    // 0x0028(0x0001)
};
...
struct FCurrentPlayerMet
{
	...
	struct FUniqueNetId                                NetId;                                                    // 0x0008(0x0010)
};
...
struct FRecentParty
{
	struct FUniqueNetId                                PartyLeader;                                              // 0x0000(0x0010)
	TArray<struct FUniqueNetId>                        PartyMembers;                                             // 0x0010(0x0010) (NeedCtorLink)
};
